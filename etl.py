...
def main():
    ...
    process_data(cur, conn, filepath='data/data_files/song_data', func=process_song_file)
    process_data(cur, conn, filepath='data/data_files/logs', func=process_log_file)
